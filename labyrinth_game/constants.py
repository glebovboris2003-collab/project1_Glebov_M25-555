...
ROOMS = {
    ...
    # Мои комнаты:
    'corridor': {
        'description': 'Вы в длинном коридоре. Справа вы видите старые доспехи на стенде.', # noqa: E501
        'exits': {'west': 'hall', 'south': 'trap_room', 'east': 'bedroom'},
        'items': ['old_armor'],
        'puzzle': None
    },
    'bedroom': {
        'description': 'Вы в покоях короля. В комнате вы видите кровать и письменный стол.', # noqa: E501
        'exits': {'west': 'corridor'},
        'items': ['old_note'],
        'puzzle': None
    }
